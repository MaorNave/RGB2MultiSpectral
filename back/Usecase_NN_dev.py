...
def main():
    ...
    # kwargs = {'main_path': ".\\results\\sentilet_data\\full_dataset",
    # 'train_batch_size': 32,
    # 'val_batch_size': 16,
    # 'num_classes': 6,
    # 'lr': 0.0001,
    ...
    #          'path_to_trained_weights': ".\\input\\net_weights\\fab_25_session_with_self_annotations\\new_model_weights_lr_0.0001_775.pth",
    #          'input_image_path': ".\\results\sentilet_data\\full_dataset\\test\images\T36RXV_20240613T081611_20m_patch_152_15.jpg",
    #          'gt_mask_path': ".\\results\sentilet_data\\full_dataset\\test\masks\T36RXV_20240613T081611_20m_patch_152_15.png"}
    #
    # test_session(kwargs)
